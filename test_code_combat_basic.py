#!/usr/bin/env python3
"""Test base per Code Combat Parte 2 â€” incapsulamento e visibilitÃ .
...
def test_runner_take_damage_decrements_integrity():
    """take_damage continua a sottrarre integritÃ ."""
...
def test_runner_take_damage_does_not_go_below_zero():
    """take_damage non porta l'integritÃ  sotto zero (invariante della Parte 1)."""
...
def test_runner_is_alive_reflects_integrity():
    """is_alive resta True finchÃ© integrity > 0."""
...
def test_runner_str_contains_handle_and_integrity():
    """__str__ del Runner contiene handle e integritÃ  corrente."""
